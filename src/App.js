...
import bekir from "./assets/bekir-mıh.png";
  ...
  <div className="w-[100%] h-[100vh]  flex flex-col lg:flex-row items-center justify-center lg:justify-evenly">
   ...
   <div>
    ...
    <div className="flex flex-col items-start justify-center">
     ...
     <a href="https://ozteknikrekor.com.tr/" target="_blank" className={aClass}>
     ...
     <a
      ...
      // target="_blank"
     >
      <img alt="icon" className={iconClass + "grayscale"} src={linkedin} />
